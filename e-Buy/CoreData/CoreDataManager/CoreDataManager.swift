...
class CoreDataManager {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        let container = NSPersistentContainer(name: "e-BuyCoreDataModel")
    ...
    func insertCartItem(cartItem: CartItem, qtyTypeProcess: qtyTypeProcess) {
        ...
        if checkCartItemBeforeInsert(cartItem: cartItem, qtyTypeProcess: qtyTypeProcess) {
            ...
            let managedObjectContext = persistentContainer.viewContext
            let entity           = NSEntityDescription.entity(forEntityName: "ShoppingCart", in: managedObjectContext)!
            ...
            cartItemCoreData.setValue(cartItem.variant_id, forKey: "varientId")
    ...
    func getAllWithArray( completion: @escaping ((Result<[CartItem], ErrorMessages>) -> Void)) {
        ...
        getAllOfNSManageObjectArr { result in
            ...
            case .success(let arr):
                for item in arr{
                    let cartItem = CartItem(name: item.value(forKey: "name") as! String, price: item.value(forKey: "price") as! String, imgUrl: item.value(forKey: "imageURL") as! String,id: item.value(forKey: "id") as! String,qty: item.value(forKey: "quantity") as! String,variant_id: item.value(forKey: "varientId") as! String )
